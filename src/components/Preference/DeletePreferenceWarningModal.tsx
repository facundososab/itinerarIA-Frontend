...
export default function DeletePreferenceWarningModal({
  onClose,
  onDelete,
  PreferenceId,
}: {
  onClose: () => void;
  onDelete: (PreferenceId: ObjectId) => void;
  PreferenceId: ObjectId | null;
}) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="rounded-lg shadow-lg p-6 w-full max-w-md bg-raisin-black">
        ...
        <div className="flex justify-between">
          ...
          <button
            onClick={() => (PreferenceId ? onDelete(PreferenceId) : null)}
